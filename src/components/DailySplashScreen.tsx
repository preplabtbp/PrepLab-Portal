          ...
          >
            ...
            >
              <div className="flex items-center justify-between">
                ...
                {(() => {
                  const isAi = currentQuote.authorNik === '00000000000' || currentQuote.authorNik === 'AI' || String(currentQuote.authorName || '').toLowerCase().includes('generated by ai');
                  if (isAi) {
                    return (
